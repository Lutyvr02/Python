...
class Column(PassiveObject):
    def __init__(self, x, y, space):
        super().__init__(r"C:\Users\59160\OneDrive\Documents\Python\Angry\assets\img\column.png", x, y, space)


class Pig(arcade.Sprite):
    def __init__(self, x: float, y: float, space: pymunk.Space):
        super().__init__(r"C:\Users\59160\OneDrive\Documents\Python\Angry\assets\img\pig_failed.png", 0.1)
        mass = 2
